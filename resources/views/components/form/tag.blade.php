...
<div class="form-buttons">
    ...
    <div class="form-options-buttons">
        @if (isset($element->id))
            <div class="delete-button tab-button" data-endpoint="{{ route('tags_destroy', ':id') }}"><svg
        ...
        @endif
        <div class="clear-button tab-button" data-endpoint="{{ route('tags_create') }}">
        ...
        <div class="save-button tab-button" data-endpoint="{{ route('tags_store') }}"><svg
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
